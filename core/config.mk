...
ifneq ($(SERASA_BUILD),)
include vendor/serasa/config/BoardConfigSerasa.mk
endif
...
ifneq ($(SERASA_BUILD),)
ifneq ($(wildcard device/serasa/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/serasa/sepolicy/common/sepolicy.mk)
endif
endif
